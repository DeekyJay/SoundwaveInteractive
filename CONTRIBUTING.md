...
All user facing pages must be localized. The library we use for localization is https://github.com/yahoo/react-intl.
Refer to src/forms/LoginForm/LoginForm.js to see how to use localized strings.
